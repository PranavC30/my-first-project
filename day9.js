...
firstname.addEventListener('focus' , function{
    console.log('input is foucsed')
    this.style,border = '2x solid red '
...
firstname.addEventListener('input' , function(event){
    ...
    const key = event.target.name  //extracting value of name attribute used in the firstname input field 
    const data = {
